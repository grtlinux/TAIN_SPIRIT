...
public abstract class AbsJoint extends Thread {
	...
	private static final Logger log = Logger.getLogger(AbsJoint.class);
	...
	public final boolean setFlagStopThread(boolean flag) {
		this.flagStopThread = flag;
		return this.flagStopThread;
	}
